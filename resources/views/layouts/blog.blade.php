...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-light navbar-stick-dark" data-navbar="sticky">
    <div class="container">
      ...
      <div class="navbar-left p-2 bd-highlight">
      ...
      <!-- <a class="btn btn-xs btn-round btn-success mr-3" href="{{ route('carts.index') }}">Add To Cart</a> -->
      <a class="d-flex mr-2 " id="re-cart"  href="{{ route('carts.index') }}" >
       
       
          @guest
          <span class="visually-hidden ml-2 fw-500 btn btn-xs btn-round btn-info d-flex">CART 
          @else
          <span class="visually-hidden ml-2 btn btn-xs btn-round btn-info d-flex" id="cart">CART

          <img src="{{ asset('/icons/cart3.svg') }}" id="img-cart" alt="" >
          @if($carts->count() > 0) 
          
          <span class="ml-1" style="border: 1px solid red; margin-right: -10px; width: 15px; border-radius: 50%; background-color: red;">
            {{ $carts->count() }}
          </span>
          @endif
          </span>
      ...
      <!-- <a class="btn btn-xs btn-round btn-success" href="{{ route('login') }}">Sign in</a> -->
      @guest
      <li class="nav-item" style="list-style: none;">
        <a class="nav-link btn btn-xs btn-round btn-success" style="color: white;" href="{{ route('login') }}">{{ __('Login') }}</a>
      </li>
      @else
      <li class="nav-item dropdown" style="list-style: none;">
        <a id="navbarDropdown" class="nav-link dropdown-toggle btn btn-xs btn-round btn-success d-flex" style="color: white;" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
    ...
    <div class="container">
      <div class="row align-items-center">
        ...
        <div class="col-12 text-center">
          <br>
          <small>© TheThemeio 2021, All rights reserved.</small>
        </div>
