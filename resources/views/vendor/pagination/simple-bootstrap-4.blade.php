...
<nav class="flexbox mt-30">
    ...
    @if ($paginator->hasMorePages())
        <a class="btn btn-white" href="{{ $paginator->nextPageUrl() }}"><i class="ti-arrow-right fs-9 ml-4"></i> Next</a>
    @else
        <a class="btn btn-white disabled"><i class="ti-arrow-right fs-9 ml-4"></i> Newer</a>
    @endif
